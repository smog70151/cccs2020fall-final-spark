...
class Preprocess():
    ...
    def add_embedding(self, word):
        ...
        vector = np.zeros((1,self.embedding_dim))
    ...
    def pad_sequence(self, sentence):
        ...
        return sentence
    def sentence_word2idx(self, row_sentence):
        # 把句子裡面的字轉成相對應的index
        sentence_idx = []
        for word in row_sentence:
        ...
        return sentence_idx#np.array(sentence_list)#torch.LongTensor(sentence_list)
